...
static_assert(sizeof(riff_block) == 12, "Wrong size of riff_block");
static_assert(sizeof(riff_data) == 24, "Wrong size of riff_data");
static_assert(sizeof(riff_header) == 56, "Wrong size of riff_header");
